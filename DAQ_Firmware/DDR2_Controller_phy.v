...
module DDR2_Controller_phy (
	...
	defparam
		...
		DDR2_Controller_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		DDR2_Controller_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		DDR2_Controller_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		DDR2_Controller_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		DDR2_Controller_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		DDR2_Controller_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		DDR2_Controller_phy_alt_mem_phy_inst.DWIDTH_RATIO = 2,
		DDR2_Controller_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		DDR2_Controller_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 13,
		DDR2_Controller_phy_alt_mem_phy_inst.MEM_IF_BANKADDR_WIDTH = 3,
		...
		DDR2_Controller_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 7519,
		DDR2_Controller_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "7519 ps",
		DDR2_Controller_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 594,
		...
		DDR2_Controller_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 64,
...
// Retrieval info:      <PRIVATE name = "mem_if_preset" value="Micron MT47H64M16-3"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=/home/caleb/Sources/Telescope_Project/VFPIX-telescope-Code/DAQ_Firmware/DDR2_Controller_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
